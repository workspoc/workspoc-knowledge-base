...
export default function Studio(){
  const [screen,setScreen]=useState('account'),[menu,setMenu]=useState(false),[toast,setToast]=useState('');
  ...
  return <Layout title="workSPOC Studio" description="Interactive workSPOC Voice product prototype" noFooter>
    <main className={styles.app}>
      ...
      <aside className={`${styles.sidebar} ${menu?styles.open:''}`}>
        ...
        <button className={styles.home} onClick={()=>select('account')}>⌂ <span>Home</span></button>
        ...
        <div className={styles.future}><span>⚡ Actions</span><span>▥ Insights</span><span>▣ Project Central</span><span>◉ Notifications</span></div>
